...
public class Plots {
    ...
    /*
	static public XYSeries XYDensity(RoadChunk c, int nb_steps, String name, double delta_t ) {
	 ...
	 */
	static public void plotLineChart(double[] data, double delta_t, String name, String x, String y) {
	...
	/** @brief TODO */
	static public void plotStepChart(double[] data, double delta_t, String name, String x, String y) {
		XYSeries s = new XYSeries(name);
		for (int i = 0; i < data.length; i++) {
			s.add((double) i * delta_t, data[i]);
		}
