...
public class CellInfo {
    ...
    public void updateInFlows(double total_in_flow) {
        ...
        Iterator<Entry<Integer, Double>> iterator = partial_densities.entrySet().iterator();
        Entry<Integer, Double> entry;
        while (iterator.hasNext()) {
            entry = iterator.next();
            in_flows.put(entry.getKey(), entry.getKey() / total_density * total_in_flow);
        }
    }
    ...
    public void updateOutFlows(double total_out_flow) {
        ...
        while (iterator.hasNext()) {
            entry = iterator.next();
            out_flows.put(entry.getKey(), entry.getKey() / total_density * total_out_flow);
        }
    ...
    public void print() {
        ...
        System.out.println("Densities:" + partial_densities.toString());
